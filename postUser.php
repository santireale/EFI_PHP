  ...
  <div class="page-wrapper">
    ...
    <div class="content clearfix">
      <div class="page-content">
        <h1 class="recent-posts-title">Publicaciones por Usuario</h1>

        <!-- FOREACH -->
        <?php
        if (isset($_GET['id'])){ // Obtengo el ID del usuario
            $cat = $_GET['id']; 
        }else{
        }
        $results = selectAllPostByUser($cat); // Obtengo todas las publicaciones realizadas por el usuario
        if (empty($results)){
          ?>
            <h2 class="post-title">No existen post de este usuario :(</h2>
          <?php
        }
        ...
        ?>
          <div class="post clearfix">
            ...
            <div class="post-content">
              ...
              <div class="post-info">
              <?php
                $resultsUser = selectOneUserById($id_usuario); // Obtengo los datos del autor del post
              ?>
              ...
              <?php
              $resultsCategory = selectOneCategory($id_categoria); // Obtengo los datos de la categoria del post
              ?>
              <br>
