...
$mail->addAddress($useremail, 'New User'); // Add a recipient // Agrego el destinatario del email

// Content
$mail->isHTML(true); // Set email format to HTML
$mail->Subject = '';
$mail->Body = '<html><p>Su contraseña ah sido restaurada!</p></br>'. // Creo el cuerpo del email
